			...
			<div class="span2 main-menu-span">
				<div class="well nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<ul><a class="" href=""><i class="icon-Pencil"></i><span class="hidden-tablet" role = "treeitem"> Diterbitkan </span></a></ul>
						</span></a>
						</li>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="container-fluid">
						<div class="row-fluid">
							<div class="span12">
								<table class="table table-striped" align="center" action="viewpost.php">
									<thead>
									<tr>
										<th>Tanggal</th>
										<th>Judul</th>
