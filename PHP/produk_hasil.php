...
//include "page.php";		
				...
				$ada= mysql_query("SELECT*FROM produk where kategori_produk like '%Hasil%' LIMIT $posisi, $batas");
				...
				$tampil2 = mysql_query("SELECT * FROM produk where kategori_produk like '%Hasil%' ");
